...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_COLEMAK] = LAYOUT_split_3x5_3(
    ...
    LT(_NUM, KC_ESC), LT(_LWR, KC_BSPC) , LT(_MOUSE, KC_TAB),   KC_ENT , LT(_RAISE, KC_SPC), KC_HYPR
  ),
  ...
  [_LWR] = LAYOUT_split_3x5_3(
    ...
    KC_LOPT, KC_LCTL, KC_LCMD, KC_LSFT, XXXXXXX,   KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT, KC_VOLD,
  ...
  [_ADJUST] = LAYOUT_split_3x5_3(
    RESET  , XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,   XXXXXXX, KC_F7  , KC_F8  , KC_F9  , KC_F10 ,
